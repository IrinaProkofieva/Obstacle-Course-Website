...
const MainPage = () => {
    ...
    return (
        <div className="main-page">
            {/*<BasicHeader text="Главная" color="#BEAA00"/>*/}
            ...
            <div className="mobile-content">
                <MobileContent text={text1} imgsrc={photo1} width="80vw" height="45vh" color = "#9FB900" />
                <MobileContent text={text2} imgsrc={photo2} width="80vw" height="45vh" color = "#BEAA00" />
                <MobileContent text={text3} imgsrc={photo3} width="80vw" height="45vh" color = "#71027D" />
                <MobileContent text={text4} imgsrc={photo4} width="80vw" height="45vh" color = "#57AB00" />
            </div>
        </div>
    )
}
