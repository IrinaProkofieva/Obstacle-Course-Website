...
const TrainingsPage = () => {
    ...
    const text2 = <><p>Стоимость: 300&nbsp;р</p><p>Длительность: ~ 2&nbsp;ч</p><p>Расписание: пн/ср 20:00</p><p>Абонемент на 4 занятия: 1&nbsp;150&nbsp;р</p><p>Абонемент на 15 занятий: 3&nbsp;250&nbsp;р</p></>;
